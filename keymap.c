...
#define SF_OPT_L LSFT(LOPT(KC_LEFT))
#define SF_OPT_R LSFT(LOPT(KC_RIGHT))
#define SF_CMD_L LSFT(LCMD(KC_LEFT))
#define SF_CMD_R LSFT(LCMD(KC_RIGHT))
 ...
 * !-------+-----+-----+-----+-----+-----+-------! !-------+-----+-----+-----+-----+-----+-------!
 * |  ESC  | A/⌃ | S/⎇ | D/⌘ |F/Sym|G/Num|  Sym  ! !  Sym  |H/Num|J/Sym| K/⌘ | L/⎇ | ;/⌃ |  ' "  |
 * !-------+-----+-----+-----+-----+-----+-------' '-------+-----+-----+-----+-----+-----+-------!
 * |       |  Z  |  X  |  C  |V/🐭 |  B  |                 |  N  |M/🐭 | , < | . > | / ? |  R ⇧  |
 * !-------+-----+-----+-----+-----+-----'                 '-----+-----+-----+-----+-----+-------!
 * |       |     |     |     |     |                             |     |     |     |     |       |
 ...
 *                                                                      generated by [keymapviz] */
    ...
    [BASE] = LAYOUT(
            ...
            _______, _______, _______, _______, _______,         ___X___,       GAM_LYR,          _______, _______, _______, _______,  _______,
 ...
 *                                                                      generated by [keymapviz] */
    ...
    [SYMB] = LAYOUT(
            ...
            ___X___, ___X___, ___X___, ___X___, ___X___,          _______,       _______,          ___X___, ___X___, ___X___, ___X___, ___X___,
                                                  CMD_L,  CMD_R,  _______,       _______, SF_CMD_L,SF_CMD_R
            ),
 ...
 *                                                                      generated by [keymapviz] */
    ...
    [MOUSE] = LAYOUT(
          ...
          _______, RM_SATU, RM_SATD, RM_NEXT, RM_PREV,  _______, _______,        _______, _______, _______, _______, _______, _______, _______,
          _______, RM_VALD, RM_VALD, LED_RED, LED_GRN,  RM_TOGG, _______,        _______, MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, _______, _______,
          _______, RM_HUEU, RM_HUED, LED_BLU, LED_ORNG, LED_PUPL,                         _______, MS_BTN1, MS_BTN2, _______, _______, _______,
 ...
 *                                                                      generated by [keymapviz] */
    ...
    [GAME] = LAYOUT(
          ...
          _______,  KC_Q,     KC_W,   KC_E,    KC_R,    KC_P,  _______,        _______, _______, _______, _______, _______, _______, _______,
          KC_LCTL,  HOME_A,   KC_S,   KC_D,    KC_F,    KC_G,  _______,        _______, _______, _______, _______, _______, _______, _______,
          ...
          KC_F1,    KC_F2,    KC_F3,  KC_F4,   KC_F5,          _______,        _______,          _______, _______, _______, _______, _______,
                                            THUM_SPC, _______, _______,        _______, _______, _______
          )
};
