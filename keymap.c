...
#define SF_OPT_L LSFT_T(LOPT(KC_LEFT))
#define SF_OPT_R LSFT_T(LOPT(KC_RIGHT))
#define SF_CMD_L LSFT_T(LCMD(KC_LEFT))
#define SF_CMD_R LSFT_T(LCMD(KC_RIGHT))
 ...
 *                                                                      generated by [keymapviz] */
    ...
    [MOUSE] = LAYOUT(
          ...
          _______, RGB_SAI, RGB_SAD, RGB_MOD, RGB_RMOD, RGB_M_B, _______,        _______, _______, _______, _______, _______, _______, _______,
